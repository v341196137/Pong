...
if (month == 4) and (day == 1):
    ...
    theme = "joseph"
    ballImage = pygame.image.load("thonk.gif")
    paddleImage = pygame.image.load("creeper.png")
elif (month == 10) and (day == 31):
    theme = "halloween"
    ballImage = pygame.image.load("halloweenBall.png")
    paddleImage = pygame.image.load("bone.png")
elif (month == 12) and (day == 25):
    theme = "christmas"
    ballImage = pygame.image.load("christmasBall.png")
    paddleImage = pygame.image.load("christmasPaddle.png")
else:
    theme = "default"
